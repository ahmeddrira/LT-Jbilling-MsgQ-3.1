...
<div id="product-box">
        ...
        <div class="form-columns">
            <g:formRemote name="filter-form" url="[action: 'products']" update="ui-tabs-2">
        ...
        <g:if test="${products?.totalCount > params.max}">
            <div class="pager-box">
                <util:remotePaginate action="products" id="${selectedCategoryId}" total="${products.totalCount}" update="columns1"/>
            </div>
        </g:if>
