...
INSERT INTO contact_type (id,OPTLOCK)
    VALUES (1,0);
...
INSERT INTO currency (id,symbol,code,country_code,OPTLOCK)
    VALUES (1,'US$','USD','US',0);
...
INSERT INTO currency (id,symbol,code,country_code,OPTLOCK)
    VALUES (7,'Sf','CHF','CH',0);


INSERT INTO currency (id,symbol,code,country_code,OPTLOCK)
    VALUES (8,'SeK','SEK','SE',0);
...
INSERT INTO currency_exchange (id,entity_id,currency_id,rate,create_datetime,valid_since,OPTLOCK)
    VALUES (1,0,2,1.325,'2004-03-09 00:00:00','1970-01-01',1);


INSERT INTO currency_exchange (id,entity_id,currency_id,rate,create_datetime,valid_since,OPTLOCK)
    VALUES (2,0,3,0.8118,'2004-03-09 00:00:00','1970-01-01',1);


INSERT INTO currency_exchange (id,entity_id,currency_id,rate,create_datetime,valid_since,OPTLOCK)
    VALUES (3,0,4,111.4,'2004-03-09 00:00:00','1970-01-01',1);


INSERT INTO currency_exchange (id,entity_id,currency_id,rate,create_datetime,valid_since,OPTLOCK)
    VALUES (4,0,5,0.5479,'2004-03-09 00:00:00','1970-01-01',1);


INSERT INTO currency_exchange (id,entity_id,currency_id,rate,create_datetime,valid_since,OPTLOCK)
    VALUES (5,0,6,1171,'2004-03-09 00:00:00','1970-01-01',1);


INSERT INTO currency_exchange (id,entity_id,currency_id,rate,create_datetime,valid_since,OPTLOCK)
    VALUES (6,0,7,1.23,'2004-07-06 00:00:00','1970-01-01',1);


INSERT INTO currency_exchange (id,entity_id,currency_id,rate,create_datetime,valid_since,OPTLOCK)
    VALUES (7,0,8,7.47,'2004-07-06 00:00:00','1970-01-01',1);


INSERT INTO currency_exchange (id,entity_id,currency_id,rate,create_datetime,valid_since,OPTLOCK)
    VALUES (10,0,9,1.68,'2004-10-12 00:00:00','1970-01-01',1);


INSERT INTO currency_exchange (id,entity_id,currency_id,rate,create_datetime,valid_since,OPTLOCK)
    VALUES (11,0,10,3.8,'2004-10-12 00:00:00','1970-01-01',1);


INSERT INTO currency_exchange (id,entity_id,currency_id,rate,create_datetime,valid_since,OPTLOCK)
    VALUES (12,0,11,1.288,'2007-01-25 00:00:00','1970-01-01',1);
...
INSERT INTO jbilling_table (id,name)
    VALUES (101,'report_type');


INSERT INTO jbilling_table (id,name)
    VALUES (102,'report_parameter');


INSERT INTO jbilling_table (id,name)
    VALUES (103,'plan_item_bundle');


INSERT INTO jbilling_table (id,name)
    VALUES (104,'notification_category');


INSERT INTO jbilling_table (id,name)
    VALUES (105,'enumeration');


INSERT INTO jbilling_table (id,name)
    VALUES (106,'enumeration_values');
...
INSERT INTO jbilling_seqs (name,next_id)
    VALUES ('permission_role_map',1);


INSERT INTO jbilling_seqs (name,next_id)
    VALUES ('permission_user',1);
...
INSERT INTO jbilling_seqs (name,next_id)
    VALUES ('price_model',0);


INSERT INTO jbilling_seqs (name,next_id)
    VALUES ('price_model_attribute',0);
...
INSERT INTO jbilling_seqs (name,next_id)
    VALUES ('report_parameter',0);


INSERT INTO jbilling_seqs (name,next_id)
    VALUES ('plan_item_bundle',0);
...
INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (23,1,'description',1,'Item management and order line total calculation');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (23,2,'description',1,'Billing process: order filters');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (23,3,'description',1,'Billing process: invoice filters');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (23,4,'description',1,'Invoice presentation');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (23,5,'description',1,'Billing process: order periods calculation');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (23,6,'description',1,'Payment gateway integration');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (23,7,'description',1,'Notifications');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (23,8,'description',1,'Payment instrument selection');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (23,9,'description',1,'Penalties for overdue invoices');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (23,10,'description',1,'Alarms when a payment gateway is down');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (23,11,'description',1,'Subscription status manager');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (23,12,'description',1,'Parameters for asynchronous payment processing');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (23,13,'description',1,'Add one product to order');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (23,14,'description',1,'Product pricing');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (23,15,'description',1,'Mediation Reader');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (23,16,'description',1,'Mediation Processor');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (23,17,'description',1,'Generic internal events listener');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (23,18,'description',1,'External provisioning processor');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (23,19,'description',1,'Purchase validation against pre-paid balance / credit limit');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (23,20,'description',1,'Billing process: customer selection');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (23,21,'description',1,'Mediation Error Handler');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (23,22,'description',1,'Scheduled Plug-ins');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (23,23,'description',1,'Rules Generators');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (23,24,'description',1,'Ageing for customers with overdue invoices');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24,1,'title',1,'Default order totals');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24,1,'description',1,'Calculates the order total and the total for each line, considering the item prices, the quantity and if the prices are percentage or not.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24,2,'title',1,'VAT');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24,2,'description',1,'Adds an additional line to the order with a percentage charge to represent the value added tax.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24,3,'title',1,'Invoice due date');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24,3,'description',1,'A very simple implementation that sets the due date of the invoice. The due date is calculated by just adding the period of time to the invoice date.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24,4,'title',1,'Default invoice composition.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24,4,'description',1,'This task will copy all the lines on the orders and invoices to the new invoice, considering the periods involved for each order, but not the fractions of periods. It will not copy the lines that are taxes. The quantity and total of each line will be multiplied by the amount of periods.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24,5,'title',1,'Standard Order Filter');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 5,'description',1,'Decides if an order should be included in an invoice for a given billing process.  This is done by taking the billing process time span, the order period, the active since/until, etc.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 6,'title',1,'Standard Invoice Filter');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 6,'description',1,'Always returns true, meaning that the overdue invoice will be carried over to a new invoice.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 7,'title',1,'Default Order Periods');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 7,'description',1,'Calculates the start and end period to be included in an invoice. This is done by taking the billing process time span, the order period, the active since/until, etc.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 8,'title',1,'Authorize.net payment processor');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 8,'description',1,'Integration with the authorize.net payment gateway.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 9,'title',1,'Standard Email Notification');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 9,'description',1,'Notifies a user by sending an email. It supports text and HTML emails');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 10,'title',1,'Default payment information');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 10,'description',1,'Finds the information of a payment method available to a customer, given priority to credit card. In other words, it will return the credit car of a customer or the ACH information in that order.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 11,'title',1,'Testing plug-in for partner payouts');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 11,'description',1,'Plug-in useful only for testing');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 12,'title',1,'PDF invoice notification');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 12,'description',1,'Will generate a PDF version of an invoice.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 14,'title',1,'No invoice carry over');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 14,'description',1,'Returns always false, which makes jBilling to never carry over an invoice into another newer invoice.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 15,'title',1,'Default interest task');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 15,'description',1,'Will create a new order with a penalty item. The item is taken as a parameter to the task.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 16,'title',1,'Anticipated order filter');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 16,'description',1,'Extends BasicOrderFilterTask, modifying the dates to make the order applicable a number of months before it would be by using the default filter.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 17,'title',1,'Anticipate order periods.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 17,'description',1,'Extends BasicOrderPeriodTask, modifying the dates to make the order applicable a number of months before itd be by using the default task.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 19,'title',1,'Email & process authorize.net');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 19,'description',1,'Extends the standard authorize.net payment processor to also send an email to the company after processing the payment.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 20,'title',1,'Payment gateway down alarm');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 20,'description',1,'Sends an email to the billing administrator as an alarm when a payment gateway is down.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 21,'title',1,'Test payment processor');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 21,'description',1,'A test payment processor implementation to be able to test jBillings functions without using a real payment gateway.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 22,'title',1,'Router payment processor based on Custom Fields');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 22,'description',1,'Allows a customer to be assigned a specific payment gateway. It checks a custom contact field to identify the gateway and then delegates the actual payment processing to another plugin.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 23,'title',1,'Default subscription status manager');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 23,'description',1,'It determines how a payment event affects the subscription status of a user, considering its present status and a state machine.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 24,'title',1,'ACH Commerce payment processor');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 24,'description',1,'Integration with the ACH commerce payment gateway.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 25,'title',1,'Standard asynchronous parameters');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 25,'description',1,'A dummy task that does not add any parameters for asynchronous payment processing. This is the default.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 26,'title',1,'Router asynchronous parameters');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 26,'description',1,'This plug-in adds parameters for asynchronous payment processing to have one processing message bean per payment processor. It is used in combination with the router payment processor plug-ins.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 28,'title',1,'Standard Item Manager');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 28,'description',1,'It adds items to an order. If the item is already in the order, it only updates the quantity.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 29,'title',1,'Rules Item Manager');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 29,'description',1,'This is a rules-based plug-in. It will do what the basic item manager does (actually calling it); but then it will execute external rules as well. These external rules have full control on changing the order that is getting new items.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 30,'title',1,'Rules Line Total');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 30,'description',1,'This is a rules-based plug-in. It calculates the total for an order line (typically this is the price multiplied by the quantity); allowing for the execution of external rules.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 31,'title',1,'Rules Pricing');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 31,'description',1,'This is a rules-based plug-in. It gives a price to an item by executing external rules. You can then add logic externally for pricing. It is also integrated with the mediation process by having access to the mediation pricing data.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 32,'title',1,'Separator file reader');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 32,'description',1,'This is a reader for the mediation process. It reads records from a text file whose fields are separated by a character (or string).');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 33,'title',1,'Rules mediation processor');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 33,'description',1,'This is a rules-based plug-in (see chapter 7). It takes an event record from the mediation process and executes external rules to translate the record into billing meaningful data. This is at the core of the mediation component, see the ?Telecom Guide? document for more information.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 34,'title',1,'Fixed length file reader');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 34,'description',1,'This is a reader for the mediation process. It reads records from a text file whose fields have fixed positions,and the record has a fixed length.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 35,'title',1,'Payment information without validation');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 35,'description',1,'This is exactly the same as the standard payment information task, the only difference is that it does not validate if the credit card is expired. Use this plug-in only if you want to submit payment with expired credit cards.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 36,'title',1,'Notification task for testing');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 36,'description',1,'This plug-in is only used for testing purposes. Instead of sending an email (or other real notification); it simply stores the text to be sent in a file named emails_sent.txt.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 37,'title',1,'Order periods calculator with pro rating.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 37,'description',1,'This plugin takes into consideration the field cycle starts of orders to calculate fractional order periods.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 38,'title',1,'Invoice composition task with pro-rating (day as fraction)');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 38,'description',1,'When creating an invoice from an order, this plug-in will pro-rate any fraction of a period taking a day as the smallest billable unit.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 39,'title',1,'Payment process for the Intraanuity payment gateway');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 39,'description',1,'Integration with the Intraanuity payment gateway.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 40,'title',1,'Automatic cancellation credit.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 40,'description',1,'This plug-in will create a new order with a negative price to reflect a credit when an order is canceled within a period that has been already invoiced.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 41,'title',1,'Fees for early cancellation of a plan.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 41,'description',1,'This plug-in will use external rules to determine if an order that is being canceled should create a new order with a penalty fee. This is typically used for early cancels of a contract.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 42,'title',1,'Blacklist filter payment processor.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 42,'description',1,'Used for blocking payments from reaching real payment processors. Typically configured as first payment processor in the processing chain.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 43,'title',1,'Blacklist user when their status becomes suspended or higher.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 43,'description',1,'Causes users and their associated details (e.g., credit card number, phone number, etc.) to be blacklisted when their status becomes suspended or higher. ');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 44,'title',1,'JDBC Mediation Reader.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 44,'description',1,'This is a reader for the mediation process. It reads records from a JDBC database source.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 45,'title',1,'MySQL Mediation Reader.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 45,'description',1,'This is a reader for the mediation process. It is an extension of the JDBC reader, allowing easy configuration of a MySQL database source.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 46,'title',1,'Provisioning commands rules task.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 46,'description',1,'Responds to order related events. Runs rules to generate commands to send via JMS messages to the external provisioning module.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 47,'title',1,'Test external provisioning task.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 47,'description',1,'This plug-in is only used for testing purposes. It is a test external provisioning task for testing the provisioning modules.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 48,'title',1,'CAI external provisioning task.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 48,'description',1,'An external provisioning plug-in for communicating with the Ericsson Customer Administration Interface (CAI).');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 49,'title',1,'Currency Router payment processor');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 49,'description',1,'Delegates the actual payment processing to another plug-in based on the currency of the payment.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 50,'title',1,'MMSC external provisioning task.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 50,'description',1,'An external provisioning plug-in for communicating with the TeliaSonera MMSC.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 51,'title',1,'Filters out negative invoices for carry over.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 51,'description',1,'This filter will only invoices with a positive balance to be carried over to the next invoice.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 52,'title',1,'File invoice exporter.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 52,'description',1,'It will generate a file with one line per invoice generated.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 53,'title',1,'Rules caller on an event.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 53,'description',1,'It will call a package of rules when an internal event happens.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 54,'title',1,'Dynamic balance manager');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 54,'description',1,'It will update the dynamic balance of a customer (pre-paid or credit limit) when events affecting the balance happen.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 55,'title',1,'Balance validator based on the customer balance.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 55,'description',1,'Used for real-time mediation, this plug-in will validate a call based on the current dynamic balance of a customer.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 56,'title',1,'Balance validator based on rules.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 56,'description',1,'Used for real-time mediation, this plug-in will validate a call based on a package or rules');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 57,'title',1,'Payment processor for Payments Gateway.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 57,'description',1,'Integration with the Payments Gateway payment processor.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 58,'title',1,'Credit cards are stored externally.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 58,'description',1,'Saves the credit card information in the payment gateway, rather than the jBilling DB.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 59,'title',1,'Rules Item Manager 2');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 59,'description',1,'This is a rules-based plug-in compatible with the mediation module of jBilling 2.2.x. It will do what the basic item manager does (actually calling it); but then it will execute external rules as well. These external rules have full control on changing the order that is getting new items.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 60,'title',1,'Rules Line Total - 2');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 60,'description',1,'This is a rules-based plug-in, compatible with the mediation process of jBilling 2.2.x and later. It calculates the total for an order line (typically this is the price multiplied by the quantity); allowing for the execution of external rules.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 61,'title',1,'Rules Pricing 2');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 61,'description',1,'This is a rules-based plug-in compatible with the mediation module of jBilling 2.2.x. It gives a price to an item by executing external rules. You can then add logic externally for pricing. It is also integrated with the mediation process by having access to the mediation pricing data.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 63,'title',1,'Test payment processor for external storage.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 63,'description',1,'A fake plug-in to test payments that would be stored externally.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 64,'title',1,'WorldPay integration');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 64,'description',1,'Payment processor plug-in to integrate with RBS WorldPay');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 65,'title',1,'WorldPay integration with external storage');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 65,'description',1,'Payment processor plug-in to integrate with RBS WorldPay. It stores the credit card information (number, etc) in the gateway.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 66,'title',1,'Auto recharge');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 66,'description',1,'Monitors the balance of a customer and upon reaching a limit, it requests a real-time payment');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 67,'title',1,'Beanstream gateway integration');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 67,'description',1,'Payment processor for integration with the Beanstream payment gateway');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 68,'title',1,'Sage payments gateway integration');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 68,'description',1,'Payment processor for integration with the Sage payment gateway');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 69,'title',1,'Standard billing process users filter');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 69,'description',1,'Called when the billing process runs to select which users to evaluate. This basic implementation simply returns every user not in suspended (or worse) status');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 70,'title',1,'Selective billing process users filter');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 70,'description',1,'Called when the billing process runs to select which users to evaluate. This only returns users with orders that have a next invoice date earlier than the billing process.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 71,'title',1,'Mediation file error handler');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 71,'description',1,'Event records with errors are saved to a file');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 73,'title',1,'Mediation data base error handler');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 73,'description',1,'Event records with errors are saved to a database table');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 75,'title',1,'Paypal integration with external storage');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 75,'description',1,'Submits payments to paypal as a payment gateway and stores credit card information in PayPal as well');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 76,'title',1,'Authorize.net integration with external storage');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 76,'description',1,'Submits payments to authorize.net as a payment gateway and stores credit card information in authorize.net as well');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 77,'title',1,'Payment method router payment processor');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 77,'description',1,'Delegates the actual payment processing to another plug-in based on the payment method of the payment.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 78,'title',1,'Dynamic rules generator');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 78,'description',1,'Generates rules dynamically based on a Velocity template.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 79,'title',1,'Mediation Process Task');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 79,'description',1,'A scheduled task to execute the Mediation Process.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 80,'title',1,'Billing Process Task');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 80,'description',1,'A scheduled task to execute the Billing Process.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 87,'title',1,'Basic ageing');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 87,'description',1,'Ages a user based on the number of days that the account is overdue.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 88,'title',1,'Ageing process task');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 88,'description',1,'A scheduled task to execute the Ageing Process.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 89,'title',1,'Business day ageing');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24, 89,'description',1,'Ages a user based on the number of business days (excluding holidays) that the account is overdue.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24,90,'title',1,'Simple Tax Composition Task');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24,90,'description',1,'A pluggable task of the type AbstractChargeTask to apply tax item to an Invoice with a facility of exempting an exempt item or an exemp customer.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24,91,'title',1,'Country Tax Invoice Composition Task');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24,91,'description',1,'A pluggable task of the type AbstractChargeTask to apply tax item to the Invoice if the Partner''s country code is matching.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24,92,'title',1,'Payment Terms Penalty Task');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24,92,'description',1,'A pluggable task of the type AbstractChargeTask to apply a Penalty to an Invoice having a due date beyond a configurable days period.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24,93,'title',1,'Fees for early cancellation of a subscription');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (24,93,'description',1,'This plug-in will create a new order with a fee if a recurring order is cancelled too early');
...
INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (101,1,'description',1,'Invoice Reports');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (101,2,'description',1,'Order Reports');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (101,3,'description',1,'Payment Reports');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (101,4,'description',1,'Customer Reports');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (100,1,'description',1,'Total amount invoiced grouped by period.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (100,2,'description',1,'Detailed balance ageing report. Shows the age of outstanding customer balances.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (100,3,'description',1,'Number of users subscribed to a specific product.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (100,4,'description',1,'Total payment amount received grouped by period.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (100,5,'description',1,'Number of customers created within a period.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (100,6,'description',1,'Total revenue (sum of received payments) per customer.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (100,7,'description',1,'Simple accounts receivable report showing current account balances.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (100,8,'description',1,'General ledger details of all invoiced charges for the given day.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (100,9,'description',1,'General ledger summary of all invoiced charges for the given day, grouped by item type.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (100,10,'description',1,'Plan pricing history for all plan products and start dates.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (100,11,'description',1,'Total invoiced per customer grouped by product category.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (100,12,'description',1,'Total invoiced per customer over years grouped by year.');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (104,1,'description',1,'Invoices');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (104,2,'description',1,'Orders');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (104,3,'description',1,'Payments');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (104,4,'description',1,'Users');
...
INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (90,1,'description',1,'Paid');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (90,2,'description',1,'Unpaid');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (90,3,'description',1,'Carried');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,10,'description',1,'Create customer');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,11,'description',1,'Edit customer');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,12,'description',1,'Delete customer');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,13,'description',1,'Inspect customer');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,14,'description',1,'Blacklist customer');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,15,'description',1,'View customer details');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,16,'description',1,'Download customer CSV');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,17,'description',1,'View all customers');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,18,'description',1,'View customer sub-accounts');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,20,'description',1,'Create order');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,21,'description',1,'Edit order');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,22,'description',1,'Delete order');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,23,'description',1,'Generate invoice for order');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,24,'description',1,'View order details');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,25,'description',1,'Download order CSV');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,26,'description',1,'Edit line price');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,27,'description',1,'Edit line description');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,28,'description',1,'View all customers');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,29,'description',1,'View customer sub-accounts');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,30,'description',1,'Create payment');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,31,'description',1,'Edit payment');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,32,'description',1,'Delete payment');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,33,'description',1,'Link payment to invoice');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,34,'description',1,'View payment details');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,35,'description',1,'Download payment CSV');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,36,'description',1,'View all customers');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,37,'description',1,'View customer sub-accounts');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,40,'description',1,'Create product');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,41,'description',1,'Edit product');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,42,'description',1,'Delete product');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,43,'description',1,'View product details');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,44,'description',1,'Download payment CSV');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,50,'description',1,'Create product category');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,51,'description',1,'Edit product category');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,52,'description',1,'Delete product category');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,60,'description',1,'Create plan');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,61,'description',1,'Edit plan');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,62,'description',1,'Delete plan');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,63,'description',1,'View plan details');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,70,'description',1,'Delete invoice');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,71,'description',1,'Send invoice notification');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,72,'description',1,'View invoice details');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,73,'description',1,'Download invoice CSV');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,74,'description',1,'View all customers');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,75,'description',1,'View customer sub-accounts');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,80,'description',1,'Approve / Disapprove review');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,90,'description',1,'Show customer menu');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,91,'description',1,'Show invoices menu');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,92,'description',1,'Show order menu');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,93,'description',1,'Show payments & refunds menu');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,94,'description',1,'Show billing menu');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,95,'description',1,'Show mediation menu');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,96,'description',1,'Show reports menu');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,97,'description',1,'Show products menu');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,98,'description',1,'Show plans menu');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,99,'description',1,'Show configuration menu');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,100,'description',1,'Show partner menu');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,101,'description',1,'Create partner');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,102,'description',1,'Edit partner');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,103,'description',1,'Delete partner');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,104,'description',1,'View partner details');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,110,'description',1,'Switch to sub-account');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,111,'description',1,'Switch to any user');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (59,120,'description',1,'Web Service API access');
...
INSERT INTO invoice_line_type (id,description,order_position)
    VALUES (4,'interests',4);


INSERT INTO invoice_line_type (id,description,order_position)
    VALUES (5,'sub account',5);


INSERT INTO invoice_line_type (id,description,order_position)
    VALUES (6,'item one-time',3);


INSERT INTO notification_category (id)
    VALUES (1);
...
INSERT INTO notification_message_type (id,category_id,OPTLOCK)
    VALUES (1,1,1);
...
INSERT INTO role (id,role_type_id)
    VALUES (2,2);
...
INSERT INTO pluggable_task_type_category (id,interface_name)
    VALUES (1,'com.sapienter.jbilling.server.pluggableTask.OrderProcessingTask');


INSERT INTO pluggable_task_type_category (id,interface_name)
    VALUES (2,'com.sapienter.jbilling.server.pluggableTask.OrderFilterTask');


INSERT INTO pluggable_task_type_category (id,interface_name)
    VALUES (3,'com.sapienter.jbilling.server.pluggableTask.InvoiceFilterTask');


INSERT INTO pluggable_task_type_category (id,interface_name)
    VALUES (4,'com.sapienter.jbilling.server.pluggableTask.InvoiceCompositionTask');


INSERT INTO pluggable_task_type_category (id,interface_name)
    VALUES (5,'com.sapienter.jbilling.server.pluggableTask.OrderPeriodTask');


INSERT INTO pluggable_task_type_category (id,interface_name)
    VALUES (6,'com.sapienter.jbilling.server.pluggableTask.PaymentTask');


INSERT INTO pluggable_task_type_category (id,interface_name)
    VALUES (7,'com.sapienter.jbilling.server.pluggableTask.NotificationTask');


INSERT INTO pluggable_task_type_category (id,interface_name)
    VALUES (8,'com.sapienter.jbilling.server.pluggableTask.PaymentInfoTask');


INSERT INTO pluggable_task_type_category (id,interface_name)
    VALUES (9,'com.sapienter.jbilling.server.pluggableTask.PenaltyTask');


INSERT INTO pluggable_task_type_category (id,interface_name)
    VALUES (10,'com.sapienter.jbilling.server.pluggableTask.ProcessorAlarm');


INSERT INTO pluggable_task_type_category (id,interface_name)
    VALUES (11,'com.sapienter.jbilling.server.user.tasks.ISubscriptionStatusManager');


INSERT INTO pluggable_task_type_category (id,interface_name)
    VALUES (12,'com.sapienter.jbilling.server.payment.tasks.IAsyncPaymentParameters');


INSERT INTO pluggable_task_type_category (id,interface_name)
    VALUES (13,'com.sapienter.jbilling.server.item.tasks.IItemPurchaseManager');


INSERT INTO pluggable_task_type_category (id,interface_name)
    VALUES (14,'com.sapienter.jbilling.server.item.tasks.IPricing');


INSERT INTO pluggable_task_type_category (id,interface_name)
    VALUES (15,'com.sapienter.jbilling.server.mediation.task.IMediationReader');


INSERT INTO pluggable_task_type_category (id,interface_name)
    VALUES (16,'com.sapienter.jbilling.server.mediation.task.IMediationProcess');


INSERT INTO pluggable_task_type_category (id,interface_name)
    VALUES (17,'com.sapienter.jbilling.server.system.event.task.IInternalEventsTask');


INSERT INTO pluggable_task_type_category (id,interface_name)
    VALUES (18,'com.sapienter.jbilling.server.provisioning.task.IExternalProvisioning');


INSERT INTO pluggable_task_type_category (id,interface_name)
    VALUES (19,'com.sapienter.jbilling.server.user.tasks.IValidatePurchaseTask');


INSERT INTO pluggable_task_type_category (id,interface_name)
    VALUES (20,'com.sapienter.jbilling.server.process.task.IBillingProcessFilterTask');


INSERT INTO pluggable_task_type_category (id,interface_name)
    VALUES (21,'com.sapienter.jbilling.server.mediation.task.IMediationErrorHandler');


INSERT INTO pluggable_task_type_category (id,interface_name)
    VALUES (22,'com.sapienter.jbilling.server.process.task.IScheduledTask');


INSERT INTO pluggable_task_type_category (id,interface_name)
    VALUES (23,'com.sapienter.jbilling.server.rule.task.IRulesGenerator');


INSERT INTO pluggable_task_type_category (id,interface_name)
    VALUES (24,'com.sapienter.jbilling.server.process.task.IAgeingTask');
...
INSERT INTO pluggable_task_type (id,category_id,class_name,min_parameters)
    VALUES (58,17,'com.sapienter.jbilling.server.payment.tasks.SaveCreditCardExternallyTask',1);
...
INSERT INTO pluggable_task_type (id,category_id,class_name,min_parameters)
    VALUES (79,14,'com.sapienter.jbilling.server.pricing.tasks.PriceModelPricingTask',0);


INSERT INTO pluggable_task_type (id,category_id,class_name,min_parameters)
    VALUES (81,22,'com.sapienter.jbilling.server.mediation.task.MediationProcessTask',0);


INSERT INTO pluggable_task_type (id,category_id,class_name,min_parameters)
    VALUES (82,22,'com.sapienter.jbilling.server.billing.task.BillingProcessTask',0);


INSERT INTO pluggable_task_type (id,category_id,class_name,min_parameters)
    VALUES (83,22,'com.sapienter.jbilling.server.process.task.ScpUploadTask',4);


INSERT INTO pluggable_task_type (id,category_id,class_name,min_parameters)
    VALUES (84,17,'com.sapienter.jbilling.server.payment.tasks.SaveACHExternallyTask',1);


INSERT INTO pluggable_task_type (id,category_id,class_name,min_parameters)
    VALUES (85,20,'com.sapienter.jbilling.server.process.task.BillableUserOrdersBillingProcessFilterTask',0);


INSERT INTO pluggable_task_type (id,category_id,class_name,min_parameters)
    VALUES (86,17,'com.sapienter.jbilling.server.item.tasks.PlanChangesExternalTask',0);


INSERT INTO pluggable_task_type (id,category_id,class_name,min_parameters)
    VALUES (87,24,'com.sapienter.jbilling.server.process.task.BasicAgeingTask',0);


INSERT INTO pluggable_task_type (id,category_id,class_name,min_parameters)
    VALUES (88,22,'com.sapienter.jbilling.server.process.task.AgeingProcessTask',0);


INSERT INTO pluggable_task_type (id,category_id,class_name,min_parameters)
    VALUES (89,24,'com.sapienter.jbilling.server.process.task.BusinessDayAgeingTask',0);


INSERT INTO pluggable_task_type (id,category_id,class_name,min_parameters)
    VALUES (90,4,'com.sapienter.jbilling.server.process.task.SimpleTaxCompositionTask',1);


INSERT INTO pluggable_task_type (id,category_id,class_name,min_parameters)
    VALUES (91,4,'com.sapienter.jbilling.server.process.task.CountryTaxCompositionTask',2);


INSERT INTO pluggable_task_type (id,category_id,class_name,min_parameters)
    VALUES (92,4,'com.sapienter.jbilling.server.process.task.PaymentTermPenaltyTask',2);


INSERT INTO pluggable_task_type (id,category_id,class_name,min_parameters)
    VALUES (93,17,'com.sapienter.jbilling.server.order.task.CancellationFeeTask',2);
...
INSERT INTO preference_type (id,def_value)
    VALUES (19,'1');
...
INSERT INTO report_type (id,name,OPTLOCK)
    VALUES (1,'invoice',0);
...
INSERT INTO report (id,type_id,name,file_name,OPTLOCK)
    VALUES (1,1,'total_invoiced','total_invoiced.jasper',0);


INSERT INTO report_parameter (id,report_id,dtype,name)
    VALUES (1,1,'date','start_date');


INSERT INTO report_parameter (id,report_id,dtype,name)
    VALUES (2,1,'date','end_date');


INSERT INTO report_parameter (id,report_id,dtype,name)
    VALUES (3,1,'integer','period');


INSERT INTO report (id,type_id,name,file_name,OPTLOCK)
    VALUES (2,1,'ageing_balance','ageing_balance.jasper',0);


INSERT INTO report (id,type_id,name,file_name,OPTLOCK)
    VALUES (3,2,'product_subscribers','product_subscribers.jasper',0);


INSERT INTO report_parameter (id,report_id,dtype,name)
    VALUES (4,3,'integer','item_id');
...
INSERT INTO report (id,type_id,name,file_name,OPTLOCK)
    VALUES (5,4,'user_signups','user_signups.jasper',0);


INSERT INTO report_parameter (id,report_id,dtype,name)
    VALUES (8,5,'date','start_date');


INSERT INTO report_parameter (id,report_id,dtype,name)
    VALUES (9,5,'date','end_date');


INSERT INTO report_parameter (id,report_id,dtype,name)
    VALUES (10,5,'integer','period');


INSERT INTO report (id,type_id,name,file_name,OPTLOCK)
    VALUES (6,4,'top_customers','top_customers.jasper',0);


INSERT INTO report_parameter (id,report_id,dtype,name)
    VALUES (11,6,'date','start_date');


INSERT INTO report_parameter (id,report_id,dtype,name)
    VALUES (12,6,'date','end_date');


INSERT INTO report (id,type_id,name,file_name,OPTLOCK)
    VALUES (7,1,'accounts_receivable','accounts_receivable.jasper',0);


INSERT INTO report (id,type_id,name,file_name,OPTLOCK)
    VALUES (8,1,'gl_detail','gl_detail.jasper',0);


INSERT INTO report_parameter (id,report_id,dtype,name)
    VALUES (13,8,'date','date');


INSERT INTO report (id,type_id,name,file_name,OPTLOCK)
    VALUES (9,1,'gl_summary','gl_summary.jasper',0);


INSERT INTO report_parameter (id,report_id,dtype,name)
    VALUES (14,9,'date','date');


INSERT INTO report (id,type_id,name,file_name,OPTLOCK)
    VALUES (10,4,'plan_history','plan_history.jasper',0);


INSERT INTO report_parameter (id,report_id,dtype,name)
    VALUES (15,10,'integer','plan_id');


INSERT INTO report_parameter (id,report_id,dtype,name)
    VALUES (16,10,'string','plan_code');


INSERT INTO report_parameter (id,report_id,dtype,name)
    VALUES (17,10,'string','plan_description');


INSERT INTO report (id,type_id,name,file_name,OPTLOCK)
    VALUES (11,4,'total_invoiced_per_customer','total_invoiced_per_customer.jasper',0);


INSERT INTO report_parameter (id,report_id,dtype,name)
    VALUES (18,11,'date','start_date');


INSERT INTO report_parameter (id,report_id,dtype,name)
    VALUES (19,11,'date','end_date');


INSERT INTO report (id,type_id,name,file_name,OPTLOCK)
    VALUES (12,4,'total_invoiced_per_customer_over_years','total_invoiced_per_customer_over_years.jasper',0);


INSERT INTO report_parameter (id,report_id,dtype,name)
    VALUES (20,12,'string','start_year');


INSERT INTO report_parameter (id,report_id,dtype,name)
    VALUES (21,12,'string','end_year');
