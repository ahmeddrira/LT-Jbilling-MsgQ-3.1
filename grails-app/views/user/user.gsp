            ...
            <g:form action="create">
                        <table class="form"> 
                            ...
                            <tr class="form"> 
                                ...
                                <td> 
                                    <input type="password" name="verifyPassword" maxlength="20" size="20" value=""> 
                                </td> 
                            </tr> 

                            <tr class="form"> 
                                <td class="form_prompt"> 
                                    <g:message code="prompt.email"/>
                                </td> 
                                <td> 
                                    <input type="email" name="email" maxlength="50" size="50" value=""> 
                                </td> 
                            </tr>        
                            
                            <tr class="form"> 
                                <td class="form_prompt"> 
                                    <g:message code="prompt.role"/>
                                </td> 
                                <td> 
                                    <g:selectRoles name="mainRoleId" languageId="${languageId}"/>
                                </td> 
                            </tr>              
