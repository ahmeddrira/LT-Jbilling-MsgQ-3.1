 ...
 *          display-name="Object representation of the table INVOICE_DELIVERY_METHOD"
 *          view-type="local" 
 *          type="CMP" 
 *          local-jndi-name="com/sapienter/jbilling/server/entity/InvoiceDeliveryMethodEntityLocal"
 *          jndi-name="com/sapienter/jbilling/server/entity/InvoiceDeliveryMethodEntity"
 *          reentrant="false"
 *          cmp-version="2.x"
 *          primkey-field="id"
 *          schema="invoice_delivery_method"
 *
 * @ejb:pk class="java.lang.Integer"
 *         generate="false"
 *
 * @jboss:table-name "invoice_delivery_method"
 * @jboss.read-only read-only="true"
 * @jboss:create-table create="false"
 * @jboss:remove-table remove="false"
 */
public abstract class InvoiceDeliveryMethodEntityBean implements EntityBean {
    ...
    public Set<CompanyDTO> getEntitys() {
        return new InvoiceDeliveryMethodDAS().find(getId()).getEntities();
    }
    /**
     * @ejb:interface-method view-type="local"
     */
    public void setEntity(Set<CompanyDTO> entity) {
        new InvoiceDeliveryMethodDAS().find(getId()).setEntities(entity);
    }
    ...
    public void setEntityContext(EntityContext arg0)
        ...
        log = Logger.getLogger(InvoiceDeliveryMethodEntityBean.class);
    }
