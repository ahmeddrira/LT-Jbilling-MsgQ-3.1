...
public class CappedGraduatedPricingStrategyTest extends BigDecimalTestCase {
    ...
    public void testMaximum() {
        ...
        strategy.applyTo(result, null, model, quantity, getUsage(0, 0));
    ...
    public void testMaximumWithExistingUsage() {
        ...
        BigDecimal quantity = new BigDecimal(1);
        strategy.applyTo(result, null, model, quantity, getUsage(2, 0));
        ...
        strategy.applyTo(result, null, model, quantity, getUsage(10, 10));
        assertEquals(BigDecimal.ZERO, result.getPrice());
    }
}
