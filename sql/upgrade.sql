...
update report set tables_list = 'base_user, purchase_order, order_line, order_line_type,international_description id, jbilling_table bt, international_description id2, international_description id3, international_description id4, generic_status gs' where id = 4;
