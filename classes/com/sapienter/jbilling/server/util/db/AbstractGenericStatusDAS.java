...
/**
 * Abtract DAS class for status classes. The AbtractDAS find and 
...
public abstract class AbstractGenericStatusDAS<T> extends AbstractDAS<T> {
    /** 
     * "id" maps to "status_value" generic_status column, rather than 
     * primary key.
     */
    @Override
    public T find(Serializable statusId) {
        ...
        return findByCriteriaSingle(Restrictions.eq("id", statusId));
    }
