...
public class BasicItemManager extends PluggableTask implements IItemPurchaseManager {
    ...
    private static final Logger LOG = Logger.getLogger(BasicItemManager.class);
    ...
    public void addItem(Integer itemId, BigDecimal quantity, Integer languageId, Integer userId, Integer entityId,
        ...
        LOG.debug("Adding " + quantity + " of item " + itemId + " to order " + order);
    ...
    protected void addNewLine(OrderDTO order, OrderLineDTO newLine) {
        LOG.debug("Adding new line to order: " + newLine);
    ...
    protected void updateExistingLine(OrderDTO order, OrderLineDTO newLine, OrderLineDTO oldLine) {
        LOG.debug("Updating existing order with line quantity & amount: " + newLine);
    ...
    protected OrderLineDTO getOrderLine(Integer itemId, Integer languageId, Integer userId, Integer currencyId,
        ...
        if (records != null) {
            ...
            LOG.debug("Including " + fields.size() + " field(s) for pricing.");
        ...
        LOG.debug("Item " + itemId + " priced as " + item.getPrice());
        ...
        LOG.debug("Built new order line: " + line);
