...
public class MaintainAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        try {
            ...
            PluggableTaskSessionHome pluggableTaskHome =
                    (PluggableTaskSessionHome) EJBFactory.lookUpHome(
                    PluggableTaskSessionHome.class,
                    PluggableTaskSessionHome.JNDI_NAME);
            PluggableTaskSession pluggableTaskSession = pluggableTaskHome.create();
        
            GenericMaintainAction gma = new GenericMaintainAction(mapping,
                    form, request, response, servlet, pluggableTaskSession, 
                    "parameter");
