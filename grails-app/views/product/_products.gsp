...
<div class="pager-box">
    ...
    <div class="row">
        <util:remotePaginate controller="product" action="${paginateAction}" id="${selectedCategoryId}" params="[partial: true, sort: params.sort, order: params.order]" total="${products?.totalCount ?: 0}" update="column2"/>
    </div>
</div>
