...
<div class="pager-box">
    ...
    <div class="row">
        <util:remotePaginate controller="product" action="${paginateAction}" id="${selectedCategoryId}" params="${sortableParams(params: [partial: true])}" total="${params.totalCount ?: 0}" update="column2"/>
    </div>
</div>
