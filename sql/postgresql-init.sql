...
INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (99,1,'description',1,'Referral Fee');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (99,2,'description',1,'Payment Processor');


INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (99,3,'description',1,'IP Address');
...
INSERT INTO international_description (table_id,foreign_id,psudo_column,language_id,content)
    VALUES (101,4,'description',1,'User Reports');
...
INSERT INTO pluggable_task_type (id,category_id,class_name,min_parameters)
    VALUES (80,14,'com.sapienter.jbilling.server.pricing.tasks.TieredPriceModelPricingTask',0);
...
;
ALTER TABLE item
    ADD CONSTRAINT item_FK_2 FOREIGN KEY (price_model_id)
...
;
ALTER TABLE plan_item
    ADD CONSTRAINT plan_item_FK_3 FOREIGN KEY (price_model_id)
    REFERENCES price_model (id)
;
ALTER TABLE plan_item
    ADD CONSTRAINT plan_item_FK_4 FOREIGN KEY (plan_item_bundle_id)
