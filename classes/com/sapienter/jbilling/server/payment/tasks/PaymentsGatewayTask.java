...
public class PaymentsGatewayTask extends PaymentTaskWithTimeout implements
    ...
    */
    ...
    private String getChargeData(PaymentDTOEx paymentInfo, int method, boolean preAuth) 
        throws PluggableTaskException {
        ...
        try {
            ...
            payloadData+="pg_total_amount="+ (paymentInfo.getAmount()).toString()+"\n";
            payloadData+="pg_transaction_type="+getTransType(paymentInfo, method, preAuth)+"\n";
            //common data
            ...
            payloadData+="Ecom_BillTo_Postal_Name_First="+entity.getFirstName()+"\n";
            payloadData+="Ecom_BillTo_Postal_Name_Last="+entity.getLastName()+"\n";

            if ("true".equals(getOptionalParameter(PARAMETER_AVS, "false"))) {
                    
                payloadData+="ecom_billto_postal_street_line1="+entity.getAddress1()+"\n";
                payloadData+="ecom_billto_postal_street_line2="+entity.getAddress2()+"\n";
                payloadData+="ecom_billto_postal_city="+entity.getCity()+"\n";
                payloadData+="ecom_billto_postal_stateprov="+entity.getStateProvince()+"\n";
                payloadData+="ecom_billto_postal_postalcode="+entity.getPostalCode()+"\n";
                payloadData+="ecom_billto_postal_countrycode="+entity.getCountryCode()+"\n";
                payloadData+="ecom_billto_telecom_phone_number="+entity.getPhoneNumber()+"\n";
            ...
            if (paymentInfo.getCreditCard() != null ) {
                ...
                payloadData+="ecom_payment_card_name="+paymentInfo.getCreditCard().getName()+"\n";
                payloadData+="ecom_payment_card_number="+paymentInfo.getCreditCard().getNumber()+"\n";

                Calendar calendar = Calendar.getInstance();
                calendar.setTime(paymentInfo.getCreditCard().getCcExpiry());

                payloadData+="ecom_payment_card_expdate_month="+calendar.get(Calendar.MONTH)+"\n";
                payloadData+="ecom_payment_card_expdate_year="+calendar.get(Calendar.YEAR)+"\n";
                payloadData+="ecom_payment_card_verification="+paymentInfo.getCreditCard().getSecurityCode()+"\n";
                ...
                String accType = "";
                payloadData+="Ecom_Payment_Check_TRN="+paymentInfo.getAch().getAbaRouting()+"\n";
                payloadData+="Ecom_Payment_Check_Account="+paymentInfo.getAch().getBankAccount()+"\n";
                ...
                if(paymentInfo.getAch().getAccountType() == 1) {
                    ...
                    log.error("unknown Account Type : "+paymentInfo.getAch().getAccountType());
...
EFT         
    ...
    private PaymentAuthorizationDTO processPGRequest(String data) 
        ...
        dbRow.setProcessor("PaymentGateway");
    ...
    public boolean confirmPreAuth(PaymentAuthorizationDTO auth,
        ...
        log.error("Prcessing confitmPreAuth Reqquest");
        boolean retValue = false;
...
private BufferedReader callPG(String data) throws PluggableTaskException {
        ...
        if ("true".equals(getOptionalParameter(PARAMETER_TEST, "false"))) {
            ...
            port = Integer.valueOf(super.ensureGetParameter(PARAMETER_TEST_PORT)).intValue();
            log.debug("Running task in test mode!");
        } else {
            host = super.ensureGetParameter(PARAMETER_HOST);
            port = Integer.valueOf(super.ensureGetParameter(PARAMETER_PORT)).intValue();
        }
