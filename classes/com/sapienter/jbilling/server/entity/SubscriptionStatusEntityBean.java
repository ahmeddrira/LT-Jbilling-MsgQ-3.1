...
/**
 * @ejb:bean name="SubscriptionStatusEntity" 
 *          display-name="Object representation of the table subscriber_status"
 *          view-type="local" 
 *          type="CMP" 
 *          local-jndi-name="com/sapienter/jbilling/server/entity/SubscriptionStatusEntityLocal"
 *          jndi-name="com/sapienter/jbilling/server/entity/SubscriptionStatusEntity"
 *          reentrant="false"
 *          cmp-version="2.x"
 *          primkey-field="id"
 *          schema="subscriber_status"
 *
 * @ejb:pk class="java.lang.Integer"
 *         generate="false"
 *
 * @jboss:table-name "subscriber_status"
 * @jboss.read-only read-only="true"
 * @jboss:create-table create="false"
 * @jboss:remove-table remove="false"
 */
public abstract class SubscriptionStatusEntityBean implements EntityBean {
    ...
    public void setEntityContext(EntityContext arg0)
        ...
        log = Logger.getLogger(SubscriptionStatusEntityBean.class);
    }
