...
public class WSMethodSecurityProxy extends WSMethodBaseSecurityProxy {
    ...
    public void before(final Method m, final Object[] args, final Object bean) throws SecurityException {
    ...
    public void invokeInTransaction(Method m, Object[] args, Object bean) throws SecurityException {
        try {
            if (m.getName().equals("getInvoiceWS")
                || m.getName().equals("payInvoice")
                ...
                try {
                    ...
                    Integer entityId = new ContactTypeDAS().find(contactTypeId).getEntity().getId();
                    if (!entityId.equals(getCallerCompanyId())) {
                ...
                if (!itemEntityId.equals(getCallerCompanyId())) {
