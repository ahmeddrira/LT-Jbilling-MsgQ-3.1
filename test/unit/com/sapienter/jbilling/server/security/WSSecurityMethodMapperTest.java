...
public class WSSecurityMethodMapperTest extends TestCase {
    ...
    public void testWSSecureMethodEnum() throws Exception {
        WSSecurityMethodMapper.WSSecureMethod method = WSSecurityMethodMapper.WSSecureMethod.GET_USER;
        assertNotNull(method);
    }

    public void testWSSecureMethodType() throws Exception {
        WSSecurityMethodMapper.Type type = WSSecurityMethodMapper.Type.USER;
        assertNotNull(type);
    }
}
