...
ALTER TABLE ONLY public.user_organization_types DROP CONSTRAINT user_organization_types_fk_1;
...
ALTER TABLE ONLY public.purchase_order DROP CONSTRAINT purchase_order_fk_7;
...
ALTER TABLE ONLY public.partner DROP CONSTRAINT partner_fk_5;
...
ALTER TABLE ONLY public.meta_field_organization_types DROP CONSTRAINT meta_field_organization_types_fk_1;
...
ALTER TABLE ONLY public.list_meta_field_values DROP CONSTRAINT list_meta_field_values_fk_1;
...
ALTER TABLE ONLY public.blacklist DROP CONSTRAINT blacklist_fk_3;
...
ALTER TABLE ONLY public.meta_field_value DROP CONSTRAINT meta_field_value_pkey;
...
DROP TABLE public.user_organization_types;
...
DROP TABLE public.meta_field_organization_types;
...
--
-- Name: meta_field_organization_types; Type: TABLE; Schema: public; Owner: jbilling; Tablespace: 
--

CREATE TABLE meta_field_organization_types (
    meta_field_id integer NOT NULL,
    organization_type character varying(255)
);


ALTER TABLE public.meta_field_organization_types OWNER TO jbilling;
...
CREATE TABLE partner_payout (
    ...
    partner_id integer,
    optlock integer NOT NULL,
    billed_amount numeric(22,10) NOT NULL,
    payout_amount numeric(22,10) NOT NULL
);
...
--
-- Name: user_organization_types; Type: TABLE; Schema: public; Owner: jbilling; Tablespace: 
--

CREATE TABLE user_organization_types (
    user_id integer NOT NULL,
    organization_type character varying(255)
);


ALTER TABLE public.user_organization_types OWNER TO jbilling;
...
COPY base_user (id, entity_id, password, deleted, language_id, status_id, subscriber_status, currency_id, create_datetime, last_status_change, last_login, user_name, failed_attempts, optlock, primary_role_id) FROM stdin;
10	10	46f94c8de14fb36680850768ff1b7f2a	0	1	1	9	1	2011-11-04 08:57:27.892	\N	\N	admin	0	0	2
\.
...
100	10	2011-12-04	1	0	1	3	1	2	1	1	1	\N	1	0	0	0	1	0
\.
...
COPY blacklist (id, entity_id, create_datetime, type, source, credit_card, credit_card_id, contact_id, user_id, meta_field_value_id, optlock) FROM stdin;
\.
...
29	10	role	list	\N	\N	\N	0
30	10	role	list	\N	5	Customer	0
31	10	role	edit	update	5	Customer	0
32	10	role	list	\N	3	Clerk	0
33	10	role	edit	update	3	Clerk	0
34	10	role	list	\N	2	Super user	0
35	10	role	edit	update	2	Super user	0
\.
...
100	Ensim.com	2620 Augustine Drive, Suite 140		Santa Clara	CA	95054	US	Administrator	Billing	\N	\N	877	693	6746	\N	\N	\N	billing@ensim.com	2011-11-04 08:57:27.796	0	\N	\N	0
101	Ensim.com	2620 Augustine Drive, Suite 140		Santa Clara	CA	95054	US	Administrator	Billing	\N	\N	877	693	6746	\N	\N	\N	billing@ensim.com	2011-11-04 08:57:27.928	0	\N	10	0
\.
...
10	\N	Ensim.com	2011-11-04 08:57:27.707	1	1	1
\.
...
COPY enumeration (id, name, value, entity_id, optlock) FROM stdin;
1	Reseller type	\N	10	1
\.
...
59	105	description	1	View organization customers
59	106	description	1	Reassign customer partner
59	107	description	1	Reassign order commission partner
...
28	20	description	1	Primary
17	200	description	1	Monthly
69	100	welcome_message	1	<div> <br/> <p style=font-size:19px; font-weight: bold;>Welcome to [Ensim.com] Billing!</p> <br/> <p style=font-size:14px; text-align=left; padding-left: 15;>From here, you can review your latest invoice and get it paid instantly. You can also view all your previous invoices and payments, and set up the system for automatic payment with your credit card.</p> <p style=font-size:14px; text-align=left; padding-left: 15;>What would you like to do today? </p> <ul style=font-size:13px; text-align=left; padding-left: 25;> <li >To submit a credit card payment, follow the link on the left bar.</li> <li >To view a list of your invoices, click on the ï¿½Invoicesï¿½ menu option. The first invoice on the list is your latest invoice. Click on it to see its details.</li> <li>To view a list of your payments, click on the ï¿½Paymentsï¿½ menu option. The first payment on the list is your latest payment. Click on it to see its details.</li> <li>To provide a credit card to enable automatic payment, click on the menu option Account, and then on Edit Credit Card.</li> </ul> </div>
14	100	description	1	Metered Test Product
...
COPY mediation_record (id_key, start_datetime, mediation_process_id, status_id, optlock) FROM stdin;
\.
...
1	Reseller type	CUSTOMER	LIST	f	f	1	\N	1
2	partner.prompt.fee	CUSTOMER	STRING	f	f	2	\N	1
3	ccf.payment_processor	CUSTOMER	STRING	f	f	3	\N	1
4	date field	CUSTOMER	DATE	f	f	4	\N	1
5	decimal field	CUSTOMER	DECIMAL	f	f	5	\N	1
\.


--
-- Data for Name: meta_field_organization_types; Type: TABLE DATA; Schema: public; Owner: jbilling
--

COPY meta_field_organization_types (meta_field_id, organization_type) FROM stdin;
1	PARTNER
\.
...
COPY partner (id, user_id, balance, total_payments, total_refunds, total_payouts, percentage_rate, referral_fee, fee_currency_id, one_time, period_unit_id, period_value, next_payout_date, due_payout, automatic_process, related_clerk, optlock, parent_id, is_parent) FROM stdin;
\.
...
COPY partner_payout (id, starting_date, ending_date, payment_id, partner_id, optlock, billed_amount, payout_amount) FROM stdin;
\.
...
101	11	smtp_server	\N	localhost	\N	0
102	11	port	\N	25	\N	0
103	11	ssl_auth	\N	false	\N	0
104	11	tls	\N	false	\N	0
105	11	username	\N	username	\N	0
106	11	password	\N	password	\N	0
107	12	design	\N	simple_invoice_b2b	\N	0
\.
...
COPY role (id, organization_type, inheritable) FROM stdin;
2	USER	f
3	USER	f
4	PARTNER	f
5	CUSTOMER	f
...
--
-- Data for Name: user_organization_types; Type: TABLE DATA; Schema: public; Owner: jbilling
--

COPY user_organization_types (user_id, organization_type) FROM stdin;
10	USER
\.
...
--
-- Name: meta_field_value_pkey; Type: CONSTRAINT; Schema: public; Owner: jbilling; Tablespace: 
--

ALTER TABLE ONLY meta_field_value
    ADD CONSTRAINT meta_field_value_pkey PRIMARY KEY (id);
...
--
-- Name: blacklist_fk_3; Type: FK CONSTRAINT; Schema: public; Owner: jbilling
--

ALTER TABLE ONLY blacklist
    ADD CONSTRAINT blacklist_fk_3 FOREIGN KEY (meta_field_value_id) REFERENCES meta_field_value(id);
...
--
-- Name: enumeration_fk_1; Type: FK CONSTRAINT; Schema: public; Owner: jbilling
--

ALTER TABLE ONLY enumeration
    ADD CONSTRAINT enumeration_fk_1 FOREIGN KEY (entity_id) REFERENCES entity(id);
...
--
-- Name: list_meta_field_values_fk_1; Type: FK CONSTRAINT; Schema: public; Owner: jbilling
--

ALTER TABLE ONLY list_meta_field_values
    ADD CONSTRAINT list_meta_field_values_fk_1 FOREIGN KEY (meta_field_value_id) REFERENCES meta_field_value(id);
...
--
-- Name: meta_field_organization_types_fk_1; Type: FK CONSTRAINT; Schema: public; Owner: jbilling
--

ALTER TABLE ONLY meta_field_organization_types
    ADD CONSTRAINT meta_field_organization_types_fk_1 FOREIGN KEY (meta_field_id) REFERENCES meta_field_name(id);
...
--
-- Name: partner_fk_5; Type: FK CONSTRAINT; Schema: public; Owner: jbilling
--

ALTER TABLE ONLY partner
    ADD CONSTRAINT partner_fk_5 FOREIGN KEY (parent_id) REFERENCES partner(id);
...
--
-- Name: purchase_order_fk_7; Type: FK CONSTRAINT; Schema: public; Owner: jbilling
--

ALTER TABLE ONLY purchase_order
    ADD CONSTRAINT purchase_order_fk_7 FOREIGN KEY (partner_id) REFERENCES partner(id);
...
--
-- Name: user_organization_types_fk_1; Type: FK CONSTRAINT; Schema: public; Owner: jbilling
--

ALTER TABLE ONLY user_organization_types
    ADD CONSTRAINT user_organization_types_fk_1 FOREIGN KEY (user_id) REFERENCES base_user(id);
